...
def get_load_count_2026() -> int:
    ...
    df = pd.read_sql(
        "SELECT COUNT(*) AS load_algusega_2026 FROM mtr_toitlustus_puhas WHERE aasta=2026",
        conn
    )
    conn.close()
...
def get_maksu_stats():
    ...
    SELECT 'algus_2024' AS tabel,
        a24.varasemalt, a24.jooksev, a24.jargmine,
        e.esm_2024 AS esmakordne_taotlus
    FROM algus_2024_stats a24, esmakordne e
    UNION ALL
    SELECT 'algus_2025',
        a25.varasemalt, a25.jooksev, a25.jargmine,
        e.esm_2025
