...
WHERE ym.registrikood IN (
    SELECT registrikood FROM mtr_toitlustus_jagamine WHERE algus_a = 2024
);
...
FROM yhendatud_maksud ym
WHERE ym.registrikood IN (
    SELECT registrikood FROM mtr_toitlustus_jagamine WHERE algus_a = 2025
);
...
FROM yhendatud_maksud ym
WHERE ym.registrikood IN (
    SELECT registrikood FROM mtr_toitlustus_jagamine WHERE algus_a = 2026
);
