...
url = "https://ncfailid.emta.ee/s/DFHQjB2Rsq3CK7p/download/tasutud_maksud_kaesolev_aasta.csv"

DATA_DIR = Path("data")
DATA_DIR.mkdir(exist_ok=True)

RAW_FILE = DATA_DIR / "tasutud_maksud_kaesolev_aasta.csv"
CLEAN_FILE = DATA_DIR / "tasutud_maksud_kaesolev_aasta_puhas.csv"
